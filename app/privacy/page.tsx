...
للتواصل: support@hsk-ar.com`,
    },
    {
      ...
      subsections: [
        ...
        {
          label: "عند الاشتراك المدفوع",
          items: [
            "بيانات الدفع تُعالَج بالكامل عبر مزوّد خارجي آمن (Stripe أو ما يعادله)",
            "نحن لا نحتفظ بأرقام بطاقاتك أو بياناتك البنكية",
            "نحتفظ فقط بسجل الاشتراك (تاريخ البدء، نوع الخطة، حالة الدفع)",
          ],
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        "إدارة اشتراكك وتجديده",
        "إرسال إشعارات ضرورية تتعلق بحسابك (تأكيد التسجيل، تجديد الاشتراك، تنبيهات أمنية)",
        "تحسين محتوى المنصة بناءً على أنماط الاستخدام العامة",
        "الامتثال للمتطلبات القانونية",
      ],
      note: "لا نستخدم بياناتك للإعلانات المدفوعة ولا نبيعها لأي طرف ثالث.",
    },
    {
      id: "04",
      ...
      thirdParties: [
        ...
        {
          name: "مزوّد الدفع",
          role: "معالجة المدفوعات",
          note: "بيانات الدفع لا تمرّ عبر خوادمنا",
        },
      ],
      footer:
    ...
    },
    {
      ...
      items: [
        ...
        "إيقاف الاشتراك — في أي وقت دون رسوم إضافية",
...
لطلب الحذف: hsk-ar.com/delete-account أو support@hsk-ar.com`,
    },
    {
      ...
      items: [
        ...
        "بيانات الدفع لا تُخزَّن على خوادمنا",
      ],
