...
function SignInForm() {
  ...
  // كشف إذا التطبيق شغّال داخل تطبيق iOS (Capacitor) لإخفاء Google و X
  ...
  useEffect(() => {
    ...
    setIsIOSApp(isNative && platform === "ios");
  }, []);
