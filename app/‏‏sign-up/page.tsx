...
export default function SignUpPage() {
  ...
  async function handleSubmit() {
    ...
    // نجاح: نعرض رسالة "تحقّق من بريدك" (التأكيد عبر الإيميل)
    setSuccess(true);
  }
      ...
      <div className="w-full max-w-sm">
        ...
        {success ? (
          ...
          >
            ...
            <p className="mt-2 text-[13.5px] leading-relaxed text-muted">
              ...
              <span className="font-bold text-ink" dir="ltr">{email}</span>.
              افتح الرابط لتفعيل حسابك ثم سجّل الدخول.
            </p>
            <Link
              href="/sign-in"
              className="mt-5 inline-block w-full rounded-lg bg-coral py-3.5 text-[15px] font-extrabold text-white transition-opacity hover:opacity-90"
            >
        ...
        {!success && (
          <p className="mt-6 text-center text-[13.5px] text-muted">
            لديك حساب بالفعل؟{" "}
            <Link href="/sign-in" className="font-extrabold text-coral hover:underline">
              سجّل الدخول
            </Link>
          </p>
        )}
